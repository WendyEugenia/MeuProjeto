...
<head>
    ...
    <title>Igreja Batista Nova Cidade</title>
...
<body>
    <header class="header">
        <nav class="caixa_logo">
            <img src="img/logo2.png" alt="Logo da Igreja" class="logo">
    ...
    <footer class="footer">
        ...
        <p class="footer-text">Igreja Batista Nova Cidade | Site criado por Wendy Eugenia</p>
    </footer>
